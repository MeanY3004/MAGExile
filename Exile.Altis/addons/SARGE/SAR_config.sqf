...
KRON_UPS_AI_Debug 	= 0; // Set to true for RPT info on ai froups and members
...
SAR_DETECT_HOSTILE_FROM_VEHICLE 	= 250;	// How far AI can detect hostile AI & players while in a vehicle
...
KRON_UPS_sharedist 					= 50;	// If you are spotted by AI group, how close the other AI group have to be to You , to be informed about your present position. over this, will lose target
