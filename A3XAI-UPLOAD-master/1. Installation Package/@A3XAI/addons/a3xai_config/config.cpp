...
class CfgA3XAISettings {
	...
	launcherTypes[] = {"launch_NLAW_F","launch_RPG32_F","launch_B_Titan_F","launch_I_Titan_F","launch_O_Titan_F"}; 
	...
	waypointBlacklistLand[] = {"Powerplant"};  //Affects Land vehicles (including UGVs)
